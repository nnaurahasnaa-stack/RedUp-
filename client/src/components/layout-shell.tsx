      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="md:hidden fixed inset-0 z-40 bg-background pt-20 px-6 pb-6 flex flex-col gap-6"
          >
            {user ? (
              <>
                <div className="flex items-center justify-between py-4 border-b">
                  <div className="flex flex-col">
                    <span className="font-bold text-lg text-foreground">{user.fullName}</span>
